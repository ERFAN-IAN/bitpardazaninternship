...
urlpatterns = [
    ...
    path('check_discount_code/', CheckDiscountCodeView.as_view(), name='check_discount_code'),
    ...
    path('librarylogin/', Library2FALoginView.as_view(), name='librarylogin'),
